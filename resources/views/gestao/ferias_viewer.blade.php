...
@endsection
@section('title','Ausências de utilizadores')
@section('subtitle','(Convalescenças, férias, diligência, ...)')
@section('breadcrumb')
<li class="breadcrumb-item"><a href="{{ route('index') }}">Home</a></li>
<li class="breadcrumb-item"><a href="{{ route('gestao.index') }}">Gestão</a></li>
<li class="breadcrumb-item active">Ausências de utilizadores</li>
@endsection
   ...
   <div class=" modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
         <div class="modal-header">
            <h5 class="modal-title" id="deleteFeriasModalLabel">Remover férias/diligência</h5>
         ...
         <form action="{{route('gestão.destroyUser')}}" method="POST" enctype="multipart/form-data" id="removeFeriasForm">
            <div class="modal-body">
               <p>Tem a certeza que pretende remover esta entrada de férias/diligência?<br>
...
<div class="modal puff-in-center" id="addVacation" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
   <div class=" modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
         <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Marcar férias/diligência</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
            </button>
         </div>
         <form action="{{route('gestao.ferias.add')}}" method="POST" enctype="multipart/form-data" id="addFerias">
            <div class="modal-body">
              <h6 style="margin-top: .5rem; margin-bottom: 1.25rem;">Apenas marque as férias/diligência do utilizador ao receber passaporte.</h6>
               @csrf
