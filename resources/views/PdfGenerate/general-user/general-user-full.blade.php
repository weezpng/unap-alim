   ...
   <body>
      ...
      <main>
         ...
         <div id="client">
            ...
            <h4 style="margin: 0;" class="name">De <b>{{ $date_start }}</b> até <b>{{ $date_end }}</b></h4>
         </div>
         </div>
         @if ($marcacoes!=null)
         ...
         @else
           <h3 style="margin-top: 0;">NENHUMA MARCAÇÃO</h3>
         @endif
         ...
         <div style="page-break-after: always;"></div>
           ...
           @else
             <h3 style="margin-top: 0;">NENHUMA CONFIRMAÇÃO</h3>
           @endif
         @endif
