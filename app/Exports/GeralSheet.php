...
class GeralSheet implements FromArray, ShouldAutoSize, WithColumnWidths, WithStyles, WithTitle, WithEvents
{
  ...
  public function registerEvents(): array
  {
      return [
          AfterSheet::class => function(AfterSheet $event) {
            $_custom_range = 'A3:H'.($this->last_it-2);
            $_second_range = 'A'.($this->last_it-1).':H'.($this->last_it-1);
            ...
            $event->sheet->getStyle($_second_range)->applyFromArray([
                'borders' => [
                    'horizontal' => [
                        'borderStyle' => \PhpOffice\PhpSpreadsheet\Style\Border::BORDER_THIN,
                        'color' => ['argb' => '000000'],
  ...
  public function GetTags($REF, $CIVIL, $UNIT){
  ...
  public function GetConsum($REF, $CIVIL, $UNIT){
  ...
  public function GetData(){
    ...
    foreach ($UNITS as $UNIT_KEY => $_UNIT) {

      $_1REF_MAR_MIL =  $this->GetTags('1REF', 'N', $_UNIT['slug']);
      $_2REF_MAR_MIL =  $this->GetTags('2REF', 'N', $_UNIT['slug']);
      $_3REF_MAR_MIL =  $this->GetTags('3REF', 'N', $_UNIT['slug']);
      $_1REF_MAR_CIV =  $this->GetTags('1REF', 'Y', $_UNIT['slug']);
      $_2REF_MAR_CIV =  $this->GetTags('2REF', 'Y', $_UNIT['slug']);
      $_3REF_MAR_CIV =  $this->GetTags('3REF', 'Y', $_UNIT['slug']);

      $_1REF_CONSUM_MIL =  $this->GetConsum('1REF', 'N', $_UNIT['slug']);
      $_2REF_CONSUM_MIL =  $this->GetConsum('2REF', 'N', $_UNIT['slug']);
      $_3REF_CONSUM_MIL =  $this->GetConsum('3REF', 'N', $_UNIT['slug']);
      $_1REF_CONSUM_CIV =  $this->GetConsum('1REF', 'Y', $_UNIT['slug']);
      $_2REF_CONSUM_CIV =  $this->GetConsum('2REF', 'Y', $_UNIT['slug']);
      $_3REF_CONSUM_CIV =  $this->GetConsum('3REF', 'Y', $_UNIT['slug']);
