...
class MonthlyExport implements FromArray, ShouldAutoSize, WithHeadings,WithColumnWidths,WithStyles,WithTitle,WithEvents
{
  ...
  public function title(): string
  {
    ...
    $title = $title.date('d', strtotime($this->end_date)).' '.$mes[($mes_index - 1)].' '.date('Y', strtotime($this->end_date));
